...
<div class="app-shell">
    <main class="content">
        <section class="hero-pane">
            <h1>Reset access, keep the journey.</h1>
            <p>We’ll email a secure link to help you get back into your plan.</p>
            <div class="hero-illustration" aria-hidden="true">
                <svg viewBox="0 0 520 360">
                    <defs>
                        <linearGradient id="forgotPlate" x1="0%" y1="0%" x2="0%" y2="100%">
                            <stop offset="0%" stop-color="#fff9f5"/>
                            <stop offset="100%" stop-color="#ffe0ef"/>
                        </linearGradient>
                        <linearGradient id="steamForgot" x1="0%" y1="0%" x2="0%" y2="100%">
                            <stop offset="0%" stop-color="#fff" stop-opacity=".9"/>
                            <stop offset="100%" stop-color="#fff" stop-opacity="0"/>
                        </linearGradient>
                    </defs>
                    <ellipse cx="250" cy="320" rx="220" ry="44" fill="rgba(255,255,255,0.35)"/>
                    <path d="M70 200c22 80 90 132 200 132s178-52 200-132H70z" fill="url(#forgotPlate)" stroke="#ffd3f7" stroke-width="6"/>
                    ...
                    <path d="M120 180c-26-2-33-32-9-44 18-9 34-10 37-26 3-15-8-26-8-26" fill="none" stroke="url(#steamForgot)" stroke-width="8" stroke-linecap="round"/>
                    <path d="M220 160c-24-2-30-32-7-44 16-9 29-11 32-26 3-14-7-24-7-24" fill="none" stroke="url(#steamForgot)" stroke-width="8" stroke-linecap="round"/>
                    <path d="M320 180c-20-3-26-28-7-40 14-8 25-10 27-22 2-12-6-18-6-18" fill="none" stroke="url(#steamForgot)" stroke-width="8" stroke-linecap="round"/>
            ...
            <div class="form-card">
                ...
                <div class="mini-food" aria-hidden="true">
                    <svg viewBox="0 0 200 120">
                        <defs>
                            <linearGradient id="miniBowlForgot" x1="0%" y1="0%" x2="0%" y2="100%">
                                <stop offset="0%" stop-color="#fff"/>
                                <stop offset="100%" stop-color="#ffe6f8"/>
                            </linearGradient>
                        </defs>
                        <ellipse cx="100" cy="100" rx="90" ry="18" fill="rgba(255,134,194,0.35)"/>
                        <path d="M20 60c8 30 32 52 80 52s72-22 80-52H20z" fill="url(#miniBowlForgot)" stroke="#ffd4f5" stroke-width="3"/>
...
<?php
$flashSuccess = $_SESSION['reset_success'] ?? null;
$flashError = $_SESSION['reset_error'] ?? null;
unset($_SESSION['reset_success'], $_SESSION['reset_error']);
?>
<script>
    (function() {
        const success = <?php echo $flashSuccess ? json_encode($flashSuccess) : 'null'; ?>;
        const error = <?php echo $flashError ? json_encode($flashError) : 'null'; ?>;
        if (success) {
            setTimeout(() => {
                alert(success);
